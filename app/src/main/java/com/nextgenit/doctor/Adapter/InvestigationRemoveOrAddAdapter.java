...
public class InvestigationRemoveOrAddAdapter extends RecyclerView.Adapter<InvestigationRemoveOrAddAdapter.TagListiewHolder> {
    ...
    public InvestigationRemoveOrAddAdapter(Activity activity, ArrayList<String> messageEntitie, String type) {
        mActivity = activity;
    ...
    @Override
    public InvestigationRemoveOrAddAdapter.TagListiewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_investigation_remove_or_add, null);


        return new InvestigationRemoveOrAddAdapter.TagListiewHolder(view);
    }

    @Override
    public void onBindViewHolder(InvestigationRemoveOrAddAdapter.TagListiewHolder holder, final int position) {
        ...
        if (types.equals("D")) {
            ...
            holder.mButtonSelectImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    PrescriptionEngineActivity.Show();
                }
            });
        }
