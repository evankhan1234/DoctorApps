...
public class DiagnosisRemoveOrAddAdapter extends RecyclerView.Adapter<DiagnosisRemoveOrAddAdapter.TagListiewHolder> {
    ...
    public DiagnosisRemoveOrAddAdapter(Activity activity, ArrayList<String> messageEntitie, String type) {
        mActivity = activity;
    ...
    @Override
    public DiagnosisRemoveOrAddAdapter.TagListiewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_investigation_remove_or_add, null);


        return new DiagnosisRemoveOrAddAdapter.TagListiewHolder(view);
    }

    @Override
    public void onBindViewHolder(DiagnosisRemoveOrAddAdapter.TagListiewHolder holder, final int position) {
        ...
        if (types.equals("D")) {
            ...
            holder.mButtonSelectImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    PrescriptionEngineActivity.DiagnosisShow();
                }
            });
        }
