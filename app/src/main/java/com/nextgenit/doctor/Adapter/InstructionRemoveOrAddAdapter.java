...
public class InstructionRemoveOrAddAdapter extends RecyclerView.Adapter<InstructionRemoveOrAddAdapter.TagListiewHolder> {
    ...
    public InstructionRemoveOrAddAdapter(Activity activity, ArrayList<String> messageEntitie, String type) {
        mActivity = activity;
    ...
    @Override
    public InstructionRemoveOrAddAdapter.TagListiewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_investigation_remove_or_add, null);


        return new InstructionRemoveOrAddAdapter.TagListiewHolder(view);
    }

    @Override
    public void onBindViewHolder(InstructionRemoveOrAddAdapter.TagListiewHolder holder, final int position) {
